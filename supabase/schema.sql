...
-- Session feedback — tied to a booking via its UUID (unguessable, not
-- sequential, and never publicly listed). One feedback row per booking,
-- enforced by the unique constraint below — a link can't be reused to
-- submit twice.
